...
from core.notebooks import build_notebook_tree
...
class MainWindow(QMainWindow):
    ...
    * :attr:`notebook_tree` — the notebooks tree (left): an "All Notes" root plus
      ...
      the note list to it; a right-click menu creates / renames / deletes
      notebooks. Populated from the repository by :meth:`_populate_notebook_tree`.
