...
- [ ] App launches: a minimal PySide6 main window opens from a fresh checkout (`python app.py`)
...
- [ ] `core/repository.py`: create / read / update / delete notes and notebooks through the encrypted vault, with tests
